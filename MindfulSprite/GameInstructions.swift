...
let gamesAray = [synchronizedBreathing, relaxation, mindfulnessTag, gratitude, takeAnAirBath, mindfuListening, discoverYourInnerBreath, wakeUpYourInnerEar, tastebudAdventure, memoryGame]
    ...
    let mindfuListening = Game(
        ...
        pageOne: "Choose a close friend that you trust. b) Find a natural place to sit down in a quiet place such as your room or backyard. c) Find a small object or rock that fits in your hand.",
        pageTwo: "d) Choose one friend to hold the rock for 5 minutes. The friend who is holding the rock takes 5 minutes to share how they are feeling. Are they feeling sad or happy? Did something memorable that happened that day? The person who is not holding the rock silently listens to what the rock holder is saying with out commenting or judging. Practice listening 100%.",
    ...
    let memoryGame = Game(
        ...
        pageOne: "Place 10 random items such as pens, socks and toys onto a tray or in a box. Give yourself 1 minute to look at and  try to remember as many items as he can. You will gets one point for each item he remembers. You will gets one point for each item he remembers.",
        pageTwo: "Now, cover up the tray with a towel and ask see if you can  recall the items-give yourself a point for each item you remembered correctly. You can keep playing until you get the most possible points.",
        pageThree: nil)
